...
pkgs.mkShellNoCC {
  ...
  shellHook = ''
    export CYPRESS_AZURE_PWD=$(sops decrypt /home/nixos/dotfiles/home/secrets/kinsale.yaml | yq '.PASSWORD' | tr -d '"')
    export CYPRESS_AZURE_USR=$(sops decrypt /home/nixos/dotfiles/home/secrets/kinsale.yaml | yq '.USERNAME' | tr -d '"')
    ...
    # export CYPRESS_PASSWORD="$(sops decrypt /home/nixos/dotfiles/home/secrets/kinsale.yaml | yq '.TESTING_ACCOUNTS.PIP_RO_LOWER_PASSWORD' | tr -d '"')";
    # export CYPRESS_USERNAME="$(sops decrypt /home/nixos/dotfiles/home/secrets/kinsale.yaml | yq '.TESTING_ACCOUNTS.PIP_RO_LOWER_USERNAME' | tr -d '"')";
